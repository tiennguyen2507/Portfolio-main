export const navigationItems = [
  ...
  },
  {
    path: '/login',
    label: 'LOGIN',
    class: 'border border-white text-white px-4 py-2 rounded hover:bg-gray-700 transition-all duration-300 font-medium text-xs uppercase tracking-wide text-center',
    activeClass: 'text-orange-400',
    mobileClass: 'border border-white text-white px-4 py-2 rounded hover:bg-gray-700 transition-all duration-300 font-medium text-xs uppercase tracking-wide text-center',
    external: true,
    envKey: 'LOGIN_URL'
  },
] 