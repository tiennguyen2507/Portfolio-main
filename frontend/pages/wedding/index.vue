<template>
  <div
    class="wedding-page relative min-h-[100dvh] bg-[#0A202F] overflow-x-hidden"
  >
    <main class="w-full min-h-[100dvh] py-0 px-0">
      ...
      >
        ...
        <!-- Nội dung -->
        <div
          class="relative z-10 flex flex-col gap-10 sm:gap-14 md:gap-20 lg:gap-24"
        >
          <WeddingHero />
          <WeddingGallery />
          <WeddingAbout />
        ...
        >
          <p
            class="text-sm sm:text-base md:text-xl whitespace-pre-line max-w-[95vw]"
          >
