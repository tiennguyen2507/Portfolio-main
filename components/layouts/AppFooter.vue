      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
        ...
        <div class="lg:col-span-2">
          ...
          <p class="text-orange-100 mb-6 max-w-md">
            Our solutions help connect agencies and advertisers with the right
            publishers to maximize their marketing performance.
          </p>
          <!-- Social media icons -->
          <div class="flex space-x-4">
            <a
              href="#"
              class="w-10 h-10 bg-orange-700 rounded-full flex items-center justify-center hover:bg-orange-600 transition-colors"
            >
        ...
        <div>
          ...
          <div class="space-y-3 text-orange-100">
            ...
            <div>
              ...
              <a
                href="mailto:mia@leadsmaxgroup.com"
                class="hover:text-white transition-colors"
              >
            ...
            <div>
              ...
              <a
                href="mailto:ethan@leadsmaxgroup.com"
                class="hover:text-white transition-colors"
              >
      ...
      <div class="border-t border-orange-700 pt-8">
        ...
        >
          <p class="text-orange-100">
            © 2025 Copyright Leadsmax Network. All rights reserved.
          </p>
