  ...
  >
    ...
    >
      <h1 class="text-4xl md:text-6xl lg:text-7xl font-bold mb-8 mt-24">
        <span class="text-orange-500 relative uppercase"> Let’s
        ...
        <span class="text-white uppercase">Connect</span>
      </h1>
      ...
      <div class="space-y-6 mb-12">
        ...
        >
        We’re here to listen, support, and collaborate — tell us how we can help.
      </p>
      </div>
    </div>
  </section>
