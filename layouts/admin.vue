<template>
  <div
    class="h-screen min-h-screen bg-gray-50 dark:bg-black flex flex-col overflow-hidden"
  >
    <div
      v-if="isLoading"
    ...
    <template v-else>
      <Header :admin="true" />
      <main
        class="flex-1 min-h-0 overflow-auto bg-gray-50 dark:bg-black pb-24 pt-16"
      >
